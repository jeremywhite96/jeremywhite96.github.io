...
<div className='grid md:grid-cols-4 grid-cols-2 xl:flex-col flex auto-rows-auto flex-row md:gap-8 gap-4'>
        <div className="group space-y-4 py-8 px-4 dark:bg-white bg-gray-100 border border-2 border-current rounded">
            <Trophy size={48} className="hidden sm:block dark:text-black text-current group-hover:text-green-800" />
        ...
        <div className="group space-y-4 py-8 px-4 dark:bg-white bg-gray-100 border border-2 border-current rounded">
            <XCircle size={48} className="hidden sm:block dark:text-black text-current group-hover:text-green-800" />
        ...
        <div className="group space-y-4 py-8 px-4 dark:bg-white bg-gray-100 border border-2 border-current rounded">
            <Cursor size={48} className="hidden sm:block dark:text-black text-current group-hover:text-[#DA9B25]"/>
        ...
        <div className="group space-y-4 py-8 px-4 dark:bg-white bg-gray-100 border border-2 border-current rounded">
            <Target size={48} className="hidden sm:block dark:text-black text-current group-hover:text-[#DA9B25]"/>
